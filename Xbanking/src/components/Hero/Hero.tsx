...
const Hero: FC = () => {
  ...
  return (
    <section className="flex items-center main-bg">
      <div className="container  z-10">
        <div className="flex flex-col items-center text-center max-w-5xl p-4 mx-auto">
          ...
          {/* Main Heading */}
          <h1 className="text-[80px] font-bold text-[#1f2226] leading-normal mb-8 tracking-tight xl:text-5xl lg:text-4xl">
            One-stop access to{' '}
            <span className="text-[#2FBF71] bg-[#2FBF71]/10 px-2 rounded">Staking</span>
            <br />
            <span className="text-[#FFB800] bg-[#FFB800]/10 px-2 rounded">Restaking</span> and{' '}
            <span className="text-[#4461F2] bg-[#4461F2]/10 px-2 rounded">Liquid Pools</span>
          </h1>
